...
graph TB
    subgraph "Transport Layer"
        Handler[SymbolHandler<br/>symbollisthttp]
    end
...
#### Transport層 ([symbollisthttp/handler.go](symbollisthttp/handler.go))
...
#### Handlerテスト ([symbollisthttp/handler_test.go](symbollisthttp/handler_test.go))
